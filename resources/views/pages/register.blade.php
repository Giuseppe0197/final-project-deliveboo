...
@endif
<div class="container-register justify-content-around ">
    <div class="container auth-page d-flex flex-wrap">
        ...
        <div class="register-form">
            ...
            >
                ...
                <input class="my-2 w-100 input-text" type="text" name="email" placeholder="Inserisci la tua mail"><br>

                <input class="my-2 w-100 input-text" type="password" name="password" placeholder="Inserisci una password"><br>

                <input class="my-2 w-100 input-text" type="password" name="password_confirmation" placeholder="Conferma la password"><br>

                <input class="my-2 w-100 input-text" type="text" name="restaurant_name" placeholder="Inserisci il nome dell'attività"><br>

                <input class="my-2 w-100 input-text" type="text" name="owner_name" placeholder="Inserisci il tuo nome"><br>

                <input class="my-2 w-100 input-text" type="text" name="restaurant_phone" placeholder="Inserisci il numero di telefono"><br>

                <input class="my-2 w-100 input-text" type="text" name="address" placeholder="Inserisci l'indirizzo"><br>
        ...
        <div class="login-form">
            ...
            <form action="{{route('login')}}" method="post">
                ...
                <input class="my-2 input-text w-100" type="text" name="email" placeholder="Inserisci la tua mail"><br>

                <input class="my-2 input-text w-100" type="password" name="password" placeholder="Inserisci la tua password">
                <div class="text-center"> 
