...
/* rotte di autenticazione (register, login, logout)*/ 
...
/* rotta di pagina singola per ogni ristorante dopo l'accesso(pagina specifica dello user dopo accesso) */ 
...
/* rotta con i piatti, e relativo tasto per nasconderlo agli utenti */ 
...
// rotta checkout
Route::get('/client/checkout', 'ClientController@checkout')-> name('checkout');

// API per modificare la visibilità dei piatti
Route::get('/api/dish/toggle/availability/{id}', 'RestaurantController@dishToggleAvailability') -> name('api.dish.availability.toggle');

// ROTTA PAGAMENTO 
Route::get('stripe', 'StripeController@stripe');
Route::post('payment', 'StripeController@payStripe')->name('payment');

Route::post('store/client/info' , 'ClientController@storeClientInfo')-> name('store.client.info');
